...
for ((i=0; i<500; i=i+1)); do
	...
	./REF_fast -i input.pho -t ../tissues/0.01_0.01_0.1_tumor_0.004.tissue -o output.pho -a 0.01 -b 0.01 -c 0.1 -r 0.0001 -l run.log --number-of-threads $NUMBER_OF_THREADS -e 60 --index-count 500
